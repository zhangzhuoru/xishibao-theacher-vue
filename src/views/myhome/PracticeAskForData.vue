<template>
    <div class="practiceaskfordata">
        ...
        <div class="cellbox">
            <div class="cellrow">
                <div class="lable">实习学生：</div>
                <div >{{message.name}}</div>
            </div>
        </div>
        <div class="cellbox">
            <div class="cellrow">
                <div class="lable">实习时间：</div>
                <div >{{message.time}}</div>
              </div>
        </div>
        <div class="cellbox">
            <div class="cellrow">
                <div class="lable">实习工作：</div>
                <div >{{message.special}}</div>
            </div>
        </div>
        <div class="cellbox">
            <div class="cellrow">
                <div class="lable">实习去向：</div>
                <div >{{message.unit}}</div>
              </div>
        </div>
        <div class="cellbox">
            <div class="cellrow">
                <div class="lable">是否已签约：</div>
                <div >是</div>
              </div>
        </div>
        <div class="cellbox">
  ...
  export default {
    ...
    methods: {
      ...
      isok(){
        Dialog.alert({
            message: `${this.message.name}申请通过`
          }).then(() => {
            this.$router.push({path:'/home/myhome'})
          });
